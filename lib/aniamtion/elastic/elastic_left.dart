...
class ElasticLeft extends StatefulWidget {
  ...
  final bool reverse;
  ElasticLeft({required this.repeat,required this.child, required this.play, required this.duration, required this.reverse});


  @override
  State<StatefulWidget> createState() {
    return ElasticLeftState();
  }
}

class ElasticLeftState extends State<ElasticLeft> with SingleTickerProviderStateMixin{
